...
public class EvaluationService {
    ...
    public EvaluationResponse findById(Long id) {
        Evaluation evaluation = evaluationRepository.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("Évaluation introuvable avec l'ID : " + id));
    ...
    public EvaluationResponse create(EvaluationRequest request) {
        Evaluation evaluation = Evaluation.builder()
                ...
                .matiere(matiereRepository.findById(request.getIdMatiere())
                        .orElseThrow(() -> new EntityNotFoundException("Matière introuvable")))
                .enseignant(enseignantRepository.findById(request.getIdEnseignant())
                        .orElseThrow(() -> new EntityNotFoundException("Enseignant introuvable")))
                .classe(classeRepository.findById(request.getIdClasse())
    ...
    public EvaluationResponse update(Long id, EvaluationRequest request) {
        ...
        evaluation.setMatiere(matiereRepository.findById(request.getIdMatiere())
                .orElseThrow(() -> new EntityNotFoundException("Matière introuvable")));
        evaluation.setEnseignant(enseignantRepository.findById(request.getIdEnseignant())
                .orElseThrow(() -> new EntityNotFoundException("Enseignant introuvable")));
        evaluation.setClasse(classeRepository.findById(request.getIdClasse())
                .orElseThrow(() -> new EntityNotFoundException("Classe introuvable")));

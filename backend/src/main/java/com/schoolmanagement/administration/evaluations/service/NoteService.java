...
public class NoteService {
    ...
    public NoteResponse create(NoteRequest request) {
        ...
        noteRepository.findByEvaluationIdAndEleveId(request.getIdEvaluation(), request.getIdEleve())
                .ifPresent(n -> {
                    throw new IllegalArgumentException("Une note existe déjà pour cet élève dans cette évaluation.");
                });

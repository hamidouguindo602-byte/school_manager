...
@PreAuthorize("hasRole('ADMIN') or hasAuthority('INSCRIPTION_GERER')")
public class InscriptionController {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<InscriptionResponse> mettreAJourInscription(
      @PathVariable Long id, @Valid @RequestBody InscriptionRequest request) {

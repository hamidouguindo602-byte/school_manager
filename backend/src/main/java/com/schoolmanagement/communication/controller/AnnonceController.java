...
public class AnnonceController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<AnnonceResponse> findById(
            @PathVariable Long id) {

        AnnonceResponse response =
                annonceService.findById(id);
    ...
    public ResponseEntity<AnnonceResponse> create(
            @Valid @ModelAttribute AnnonceRequest request) {
    ...
    public ResponseEntity<byte[]> getFichier(
            @PathVariable Long id) {

...
public class PasswordResetTokenController {
  ...
  @PostMapping
  public ResponseEntity<PasswordResetTokenResponse> createToken(
  ...
  public ResponseEntity<String> markTokenAsUsed(@PathVariable Long id) {
    ...
    return updated
        ? ResponseEntity.ok("Token marqué comme utilisé")
  ...
  public ResponseEntity<String> deleteToken(@PathVariable Long id) {
    ...
    return deleted ? ResponseEntity.ok("Token supprimé") : ResponseEntity.notFound().build();
  }
}
